...
public class InMemoryVocabularyCorrectionService implements VocabularyCorrectionService, RetrievalVocabularyIndexService {
    ...
    private static final Logger log = LoggerFactory.getLogger(InMemoryVocabularyCorrectionService.class);
    ...
    public void rebuild(SchemaMetadataSnapshot snapshot, List<RetrievedChunk> chunks) {
        ...
        log.info("retrievalVocabularyRebuild provider=in-memory fingerprint={} termCount={}",
                snapshot.fingerprint(), vocabulary.size());
    }
